...
namespace QUANLYQUANAO.Class
{
    internal class Fuctions
    {
        ...
        public static DataTable GetDataToTable(string sql)
        {
            ...
            dap.SelectCommand.Connection = Fuctions.Con; //Kết nối cơ sở dữ liệu
     ...
     // FillCombo có tác dụng lấy dữ liệu từ một câu lệnh SQL đổ vào một ComboBox.
        ...
        //GetFieldValues có tác dụng lấy dữ liệu từ một câu lệnh SQL.
