...
namespace QUANLYQUANAO
{
    public partial class frmDMKhachHang : Form
    {
        ...
        private void LoadDataGridView()
        {
            string sql;
            sql = "SELECT* FROM [dbo].[Khach]";
            tblKH = Fuctions.GetDataToTable(sql); //Lấy dữ liệu từ bảng
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            sql = "INSERT INTO Khach VALUES (N'" + txtMaKhach.Text.Trim() +
                "',N'" + txtTenKhach.Text.Trim() + "',N'" + txtDiaChi.Text.Trim() + "','" + txtSDT.Text + "')";
            Fuctions.RunSQL(sql);
            LoadDataGridView();
            ResetValues();
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE Khach SET TenKhach=N'" + txtTenKhach.Text.Trim().ToString() + "',DiaChi=N'" +
                txtDiaChi.Text.Trim().ToString() + "',DienThoai='" + txtSDT.Text.ToString() +
